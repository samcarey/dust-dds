...
pub struct DynamicDataWriter(DataWriterNodeKind);

pub trait DynamicDataWriterFoo1:
    DdsGetKey + DdsHasKey + DdsRepresentation + serde::Serialize
{
}
...
// impl Drop for DynamicDataWriter {
//     fn drop(&mut self) {
//         match &self.0 {
...
impl DynamicDataWriter {
    ...
    pub fn register_instance(
        &self,
        instance: &impl DynamicDataWriterFoo1,
    ...
    pub fn register_instance_w_timestamp(
        &self,
        _instance: &impl DynamicDataWriterFoo1,
        _timestamp: Time,
    ) -> DdsResult<Option<InstanceHandle>> {
        match &self.0 {
    ...
    pub fn unregister_instance(
        ...
        self.unregister_instance_w_timestamp(instance, handle, timestamp, has_key)
    }
    ...
    pub fn get_key_value(
        &self,
        _key_holder: &mut impl DynamicDataWriterFoo1,
    ...
    pub fn write(
        &self,
        data: &impl DynamicDataWriterFoo1,
        handle: Option<InstanceHandle>,
    ) -> DdsResult<()> {
        let timestamp = match &self.0 {
            DataWriterNodeKind::UserDefined(dw) | DataWriterNodeKind::Listener(dw) => {
...
pub trait DynamicDataWriterFoo2: DdsHasKey + serde::Serialize + 'static {}
...
impl DynamicDataWriter {
    ...
    pub fn set_listener(
        &self,
        _a_listener: Option<Box<dyn DynamicDataWriterListener + Send + Sync>>,
        _mask: &[StatusKind],
    ) -> DdsResult<()> {
        todo!()
        // match &self.0 {
